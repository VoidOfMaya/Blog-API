...
commentRouter.post('/',validateNewComment, createComment)

//edit comment, //takes postId, content
commentRouter.put('/:id', validateCommentEdit, updateComment)

//delete comment,// takes commentId
commentRouter.delete('/:id', valiatecommentDelete, deleteComment)
export{
    commentRouter
}