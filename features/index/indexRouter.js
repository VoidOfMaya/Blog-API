...
import { validateId, commentValidation } from '../../validations/indexValidation.js'

const indexRouter = Router({mergeParams: true});

indexRouter.get('/', getPosts);
indexRouter.get('/:id',validateId,getPostById);
indexRouter.use('/:postId/comment',midware.isAuthenticated, commentValidation, commentRouter);
